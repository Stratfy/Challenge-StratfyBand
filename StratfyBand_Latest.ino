...
const char* default_BROKER_MQTT     = "156.67.25.64";
const int   default_BROKER_PORT     = 1883;
const char* default_TOPICO_SUBSCRIBE= "/TEF/band020/cmd";
const char* default_TOPICO_PUBLISH_1= "/TEF/band020/attrs";
const char* default_TOPICO_PUBLISH_2= "/TEF/band020/attrs/scoreX";
const char* default_TOPICO_PUBLISH_3= "/TEF/band020/attrs/scoreY";
const char* default_TOPICO_PUBLISH_4= "/TEF/band020/attrs/scoreZ";
const char* default_ID_MQTT         = "fiware_band020";
const int   default_D4              = 2;

// Prefixo de mensagem
const char* topicPrefix = "band020";
